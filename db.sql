...
INSERT INTO `order_details` (`order_detail_id`, `color`, `config`, `discountvalue`, `price`, `quantity`, `product_id`) VALUES ('1', 'xanh', '128 gb', '12', '10000000', '12', '1');


INSERT INTO `orders` (`order_id`, `creation_time`, `delivery_adress`, `name_receiver`, `notes`, `payments`, `status`, `totals`, `order_detail_id`, `user_id`) VALUES 
